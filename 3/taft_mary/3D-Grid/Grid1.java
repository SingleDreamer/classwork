...
public class Grid {
    ...
    */
    ...
    public void makeRectangle(int x, int y, int side1, int side2) {
	
    }

    public void makeRectangleWithOrientation(String orientation, int layer, int s, int p, int side1, int side2) {
    ...
    */
	...
	int count = 0;
	while (count<height)
	    makeRectangleWithOrientation("top",z,x,y,width,depth);
    }
    ...
    // 	int xcorner=x-radius,ycorner=y-radius;
    // 	for (int i=xcorner; i<2*radius; i++) {
    // 	    for (int j=ycorner; j<2*radius; j++) {
    ...
    //Nor does this
    //
    // public void makeCircleWithOrientation(String orientation, int layer, int s, int p, int radius) {
    // 	//there must be a way to refactor this
    // 	int x=0,y=0,z=0;
    // 	//had to initialize for the compiler...
    // 	if (orientation.equals("top")) {
    ...
    public void printLayer(String orientation, int layer) {
    }
